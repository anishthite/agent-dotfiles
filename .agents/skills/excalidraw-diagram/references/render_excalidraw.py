...
def render(
    ...
    with sync_playwright() as p:
        ...
        # Bumped from 30s -> 120s: cold pull of @excalidraw/excalidraw bundle has many
        # transitive imports through Playwright that can exceed 30s on slow links.
        # Returns immediately once ready, so no penalty when fast.
